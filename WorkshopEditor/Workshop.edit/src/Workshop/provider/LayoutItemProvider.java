...
public class LayoutItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkshopPackage.Literals.LAYOUT__NODE);
			childrenFeatures.add(WorkshopPackage.Literals.LAYOUT__ARC);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkshopPackage.Literals.LAYOUT__NODE,
				 WorkshopFactory.eINSTANCE.createStation()));

		newChildDescriptors.add
			(createChildParameter
				(WorkshopPackage.Literals.LAYOUT__ARC,
				 WorkshopFactory.eINSTANCE.createArc()));
	}
