...
/**
 * This is the item provider adapter for a {@link Workshop.Station} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkshopPackage.Literals.STATION__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkshopPackage.Literals.STATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkshopPackage.Literals.STATION__RESSOURCE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Station.class)) {
			case WorkshopPackage.STATION__ID:
			case WorkshopPackage.STATION__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case WorkshopPackage.STATION__RESSOURCE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkshopPackage.Literals.STATION__RESSOURCE,
				 WorkshopFactory.eINSTANCE.createRessource()));
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkshopPackage.Literals.STATION__RESSOURCE,
				 WorkshopFactory.eINSTANCE.createMachine()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return WorkshopmodelEditPlugin.INSTANCE;
	}
