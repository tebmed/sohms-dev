...
/**
 * This is the item provider adapter for a {@link workshop.Ports} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortsItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ports_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ports_value_feature", "_UI_Ports_type"),
				 WorkshopPackage.Literals.PORTS__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Ports)object).getValue();
