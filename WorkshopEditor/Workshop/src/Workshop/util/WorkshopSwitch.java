	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WorkshopPackage.AGV: {
				...
				if (result == null) result = caseRessource(agv);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkshopPackage.MACHINE: {
				Machine machine = (Machine)theEObject;
				T result = caseMachine(machine);
				if (result == null) result = caseRessource(machine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
