...
public class NodeImpl extends MinimalEObjectImpl.Container implements Node {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkshopPackage.NODE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setTechnology(String newTechnology) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkshopPackage.NODE__TECHNOLOGY, oldTechnology, technology));
	}
	...
	public void setCategory(String newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkshopPackage.NODE__CATEGORY, oldCategory, category));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkshopPackage.NODE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WorkshopPackage.NODE__CATEGORY:
				return getCategory();
